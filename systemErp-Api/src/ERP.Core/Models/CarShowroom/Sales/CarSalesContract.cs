...
/// <summary>عقد بيع سيارة - يمر بدورة مبيعات معتمدة من 5 مراحل (SalesContractStatus).</summary>
public class CarSalesContract : BaseEntity
{
    ...
    /// <summary>pending | approved | disbursed</summary>
    ...
    // المركبة (تُعبّأ من منتقي المركبات)
    ...
    /// <summary>cash | credit | bank_transfer | bank_finance | pos_mada</summary>
    public string PaymentMethod { get; set; } = "cash";

    // خدمات المرور واللوحات والتأمين
    /// <summary>new | transfer | auction | export</summary>
    ...
    /// <summary>comprehensive | third_party</summary>
    public string? InsuranceType { get; set; }
    public string? InsurancePolicyNumber { get; set; }
    public decimal? InsuranceCost { get; set; }
    /// <summary>pending | verified | completed</summary>
    ...
    /// <summary>الفاتورة الضريبية المُصدَرة عند مرحلة الفوترة.</summary>
